...
- If no reliable historical information exists, say so and provide the best verified context available without inventing unsupported facts.
- Do not include cooking instructions or ingredients unless they are relevant to the historical explanation.
- Keep the tone informative, factual, and concise.

When I send you the name of a recipe, reply only with its historical background.`;